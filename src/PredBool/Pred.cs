...
namespace PredBool
{
    public static class PredExts
    {
        public static Pred<T> ToPred<T>(this Func<T,bool> p)
        {
            return new Pred<T>(p);
        } 
    }
    ...
    public class Pred
    {
        public static Pred<T> Make<T>(Func<T, bool> p)
        {
            return new Pred<T>(p);
        }
    }
    ...
    public class Pred<T>
    {
        ...
        public static Pred<T> operator !(Pred<T> p)
        {
            return new Pred<T>(c => !p._pred(c));
        }

        public static Pred<T> MakeFrom(Func<T, bool> p)
        {
            return new Pred<T>(p);
        }
    }
